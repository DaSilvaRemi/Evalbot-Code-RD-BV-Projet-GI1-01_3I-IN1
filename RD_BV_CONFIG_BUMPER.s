...
; Pull_up
GPIO_I_PUR   			EQU 	0x00000510  ; GPIO Pull-Up Select  (p432 of datasheet lm3s9B92.pdf)
...
__CONFIG_BUMPER
							...
							LDR R0, [R6]
							ORR R0, R0, #0x10  				;; Enable clock on GPIO E (0x10 == 0b0001 0000) where BUMPER were connected on (0x03 == 0b0000 0011)
							; ;;														 		(GPIO::HGFE DCBA)
							STR R0, [R6]
